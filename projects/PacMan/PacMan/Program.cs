    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    movePacManUp(maze, ref pacman.X, ref pacman.Y);
                }
                if (Keyboard.IsKeyPressed(Key.DownArrow))
                {
                    movePacManDown(maze, ref pacman.X, ref pacman.Y);
                }
                if (Keyboard.IsKeyPressed(Key.LeftArrow))
                {
                    movePacManLeft(maze, ref pacman.X, ref pacman.Y);
                }
                if (Keyboard.IsKeyPressed(Key.RightArrow))
                {
                    movePacManRight(maze, ref pacman.X, ref pacman.Y);
                }
                count1++;
                count2++;
                ...
                gameRunning = moveGhostSmart(maze, ref ghost4X, ref ghost4Y, ref previous4, pacman.X, pacman.Y);
                if (gameRunning == false)
                {
                    break;
                }
